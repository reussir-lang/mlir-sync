...
crate::runtime_export! {
    ...
    pub unsafe fn mlir_sync_rwlock_read_lock_slow_path(rwlock: *mut RwLock) {
...
crate::runtime_export! {
    ...
    /// initialized by this library. The pointed-to rwlock must remain valid for
    /// the duration of the call.
    pub unsafe fn mlir_sync_rwlock_write_lock_slow_path(rwlock: *mut RwLock) {
...
crate::runtime_export! {
    ...
    pub unsafe fn mlir_sync_rwlock_unlock_slow_path(rwlock: *mut RwLock, state: u32) {
