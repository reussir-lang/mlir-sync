...
// STD: scf.if %{{.*}} {
// STD: func.call @__sync_trampoline_mlir_sync_rwlock_unlock_slow_path(%{{.*}}, %[[WRITE_UNLOCK]]) {CConv = #llvm.cconv<preserve_mostcc>} : (!ptr.ptr<#ptr.generic_space>, i32) -> ()
// STD: }
...
// STD: scf.if %{{.*}} {
// STD: func.call @__sync_trampoline_mlir_sync_rwlock_unlock_slow_path(%{{.*}}, %[[READ_UNLOCK]]) {CConv = #llvm.cconv<preserve_mostcc>} : (!ptr.ptr<#ptr.generic_space>, i32) -> ()
// STD: }
